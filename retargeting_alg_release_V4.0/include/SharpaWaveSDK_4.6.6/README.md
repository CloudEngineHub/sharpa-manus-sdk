...
5. Run Tactile Sensing Demo:
```bash
LD_LIBRARY_PATH=../../lib && ./build/sharpa_tactile_example
```
...
```
sdk got frame: 540 in 3.015814781188965 s, frame rate: 179.05608904374049
user got frame: 539 in 3.015814781188965 s, frame rate: 178.72450369365947
```
